...
import type { StructuredConclusion } from './database';
...
export interface ApiRemoteSessionSummary {
	...
	session_semantic_projection_ready?: boolean;
	session_semantic_projection_source?: string;
	...
	mounted_tool_count?: number;
	display_projection_mode?: string;
...
export interface ApiRemoteSession {
	...
	handoff_to?: string;
	takeover_relation?: string;
	tool_availability_snapshot?: Record<string, unknown>;
	session_semantic_projection_ready?: boolean;
	session_semantic_projection_source?: string;
	semantic_binding_mode?: string;
	semantic_observability_mode?: string;
	...
	available_tool_classes_json?: string[];
	semantic_catalog_json?: unknown[] | Record<string, unknown>;
	remote_dialog_semantic_list_json?: unknown[] | Record<string, unknown>;

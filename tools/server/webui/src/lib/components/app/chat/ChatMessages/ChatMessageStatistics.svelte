<script lang="ts">
	import { Clock, Gauge, WholeWord, BookOpenText, Sparkles, Wrench, Layers, Database } from '@lucide/svelte';
	...
	let {
		...
		hideSummary = false,
		auditLabel,
		auditTooltip = 'Session / turn / intent / task binding'
	}: Props = $props();
